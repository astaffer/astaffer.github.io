...
$(function(){var n=$("#my-menu").mmenu({extensions:["theme-black","effect-menu=slide","pagedim-black"],navbar:{title:'<img src="img/logo1.png" alt="Astafev Pavel logo" />'},offCanvas:{position:"right"}}),i=$("#my-icon"),e=n.data("mmenu");i.on("click",function(){e.open()}),e.bind("open:start",function(){setTimeout(function(){i.addClass("is-active")},100)}),e.bind("close:finish",function(){setTimeout(function(){i.removeClass("is-active")},100)})});